...
export default function CommunityDetails({ navigation }) {
  ...
  const voiceChannels = ['Lounge', 'Team Talk', 'Chill Zone', 'Game VC', 'Hangout'];
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerCard}>
            ...
            <View style={styles.communityRow}>
              ...
              <View style={styles.communityInfo}>
                ...
                {nexusError ? <Text style={{ color: 'red' }}>{nexusError}</Text> : null}
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            <TouchableOpacity
              ...
              onLongPress={() => navigation.navigate("Press_Space_Creation_Flow")}
              delayLongPress={300}
            >
            ...
            {chatSpaceExpanded && (
              <>
                <TouchableOpacity
                  style={[
                    styles.channelRow,
                    activeChatChannel === 'general' && styles.channelRowActive,
                  ]}
                  onPress={() => setActiveChatChannel('general')}
                >
                  {activeChatChannel === 'general' && <View style={styles.activeIndicator} />}
                ...
                <TouchableOpacity
                  style={[
                    styles.channelRow,
                    activeChatChannel === 'announcement' && styles.channelRowActive,
                  ]}
                  onPress={() => setActiveChatChannel('announcement')}
                >
                  {activeChatChannel === 'announcement' && <View style={styles.activeIndicator} />}
              ...
              voiceChannels.map((channel, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Mic size={18} color={isActive ? '#3b82f6' : '#64748b'} />
