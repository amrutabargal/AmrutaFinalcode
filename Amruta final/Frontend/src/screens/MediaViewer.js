...
// //       {/* ---------- UPDATED Input bar (only this part changed) ---------- */}
// //       <View style={styles.inputBarContainer} pointerEvents="box-none">
// //         <View style={styles.inputBar}>
// //           {/* left quick icons: image + emoji */}
...
// //               value={inputValue}
// //               onChangeText={(t) => setInputValue(t)}
// //               placeholder="Message #general_esp..."
// //               placeholderTextColor="#9aa4c8"
...
// //             {/* small plus to attach more */}
// //             <TouchableOpacity style={styles.plusBtn}>
// //               <Ionicons name="add" size={18} color="#9fb4ff" />
// //             </TouchableOpacity>
// //           </View>

// //           {/* right area: mic OR send (depending on input) */}
// //           <View style={styles.rightIcons}>
// //             {!inputValue.trim() ? (
// //               <TouchableOpacity
// //                 style={styles.micBtn}
// //                 activeOpacity={0.7}
// //                 onPress={() => setIsRecording((s) => !s)}
// //               >
// //                 <Ionicons name={isRecording ? "mic-off" : "mic"} size={20} color="#9fb4ff" />
// //               </TouchableOpacity>
// //             ) : (
// //               <TouchableOpacity
...
// //     borderColor: "#1f2937",
// //   },
// //   leftIcons: { flexDirection: "row", alignItems: "center", marginRight: scale(6) },
// //   iconBtn: {
// //     width: scale(36),
// //     height: scale(36),
// //     justifyContent: "center",
...
// //     marginRight: scale(6),
// //   },
// //   inputWrapperNew: { flex: 1, flexDirection: "row", alignItems: "center" },
// //   inputNew: { color: "#E5ECFF", fontSize: scale(14), paddingVertical: 0, flex: 1 },
// //   plusBtn: { marginLeft: scale(8), width: scale(34), height: scale(34), borderRadius: scale(17), alignItems: "center", justifyContent: "center" },
// //   rightIcons: { marginLeft: scale(8) },
// //   micBtn: {
// //     width: scale(40),
// //     height: scale(40),
// //     borderRadius: scale(20),
